...
Reference copy for the Northwest Local Cannabis LinkedIn page. Paste-ready for the LinkedIn admin UI.

Source brand voice: `siteSettings` in Sanity and the `About Us` page (`page` document with title "About Us"). Update this file when those change so off-site profiles stay in sync.
...
> Washington-grown craft cannabis. i502-licensed producer & processor in the Pacific Northwest.

(95 characters)

**Alternates:**

- Small-batch cannabis, cultivated and processed in Washington State. i502 licensed. *(84 chars)*
- Pacific Northwest cannabis, grown and processed locally. WA i502 producer/processor. *(86 chars)*
...
Must be 21 or older. For use only by adults 21+. Keep out of reach of children. This product has intoxicating effects and may be habit-forming.

#Cannabis #WashingtonCannabis #CraftCannabis #i502 #PacificNorthwest
```
...
17 used; 3 slots free for future additions (e.g. *Live Resin*, *Solventless Hash*, specific breeder partnerships).

## Page links

- **Website:** https://nw-local.com
...
- Cannabis pages on LinkedIn are subject to discretionary policy review. Keep product imagery off the banner, avoid direct purchase links from the page, and prefer retailer-locator links instead.
- The 21+ disclaimer in the About section mirrors WSLCB-recommended phrasing for Washington State cannabis marketing materials. Mirroring on-package language across channels keeps brand voice consistent and reduces compliance ambiguity.
- Must be 21+ to consume cannabis. Marketing must not target anyone under 21 or use imagery/language appealing primarily to minors.
